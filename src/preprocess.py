...
def export_missingness_profile(before_df, after_df, output_dir='outputs/data_qc',
    ...
    summary_df['missingness_before_cleaning_pct'] = summary_df['missingness_before_cleaning_pct'].round(2)
    summary_df['missingness_after_cleaning_pct'] = summary_df['missingness_after_cleaning_pct'].round(2)
